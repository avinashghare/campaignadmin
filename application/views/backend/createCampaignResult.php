    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createCampaignResultsubmit");?>' enctype='multipart/form-data'>
...
<!--
                        <div class=" form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="reports" id="" cols="20" rows="10" class="form-control tinymce"> </textarea>
...
<!--
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="normal-field" class="form-control" name="timestamp" value='<?php echo set_value(' campaign ');?>'>
                            </div>
                        </div>
-->
                       <div class=" form-group">
