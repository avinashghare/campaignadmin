                ...
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createordersubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-sm-4">
                                <?php echo form_dropdown("Plan",$Plan,set_value( 'Plan'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
                        <div class=" form-group">
                            <label class="col-sm-2 control-label" for="normal-field">Status</label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown( "status",$status,set_value( 'Plan'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
                        <div class="form-group">
